...
public interface IEducationCandidateService {
    ...
    EducationCandidateResponse createByCandidate(String candidateId, FromEducationCandidate request);
    EducationCandidateResponse updateByCandidate(Long id, String candidateId, FromEducationCandidate request);
